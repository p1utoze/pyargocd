...
class V1alpha1ApplicationSetSpec(object):
    ...
    def __init__(self, apply_nested_selectors=None, generators=None, go_template=None, go_template_options=None, ignore_application_differences=None, preserved_fields=None, strategy=None, sync_policy=None, template=None, template_patch=None, _configuration=None):  # noqa: E501
