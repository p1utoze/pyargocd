...
class ClusterOIDCConfig(object):
    ...
    def __init__(self, cli_client_id=None, client_id=None, enable_pkce_authentication=None, id_token_claims=None, issuer=None, name=None, scopes=None, _configuration=None):  # noqa: E501
