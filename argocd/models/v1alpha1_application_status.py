...
class V1alpha1ApplicationStatus(object):
    ...
    swagger_types = {
        ...
        'source_hydrator': 'V1alpha1SourceHydratorStatus',
        'source_type': 'str',
    ...
    def __init__(self, conditions=None, controller_namespace=None, health=None, history=None, observed_at=None, operation_state=None, reconciled_at=None, resource_health_source=None, resources=None, source_hydrator=None, source_type=None, source_types=None, summary=None, sync=None, _configuration=None):  # noqa: E501
    ...
    def source_hydrator(self):
        """Gets the source_hydrator of this V1alpha1ApplicationStatus.  # noqa: E501


        :return: The source_hydrator of this V1alpha1ApplicationStatus.  # noqa: E501
        :rtype: V1alpha1SourceHydratorStatus
        """
        return self._source_hydrator

    @source_hydrator.setter
    def source_hydrator(self, source_hydrator):
        """Sets the source_hydrator of this V1alpha1ApplicationStatus.


        :param source_hydrator: The source_hydrator of this V1alpha1ApplicationStatus.  # noqa: E501
        :type: V1alpha1SourceHydratorStatus
        """
