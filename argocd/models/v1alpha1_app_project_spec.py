...
class V1alpha1AppProjectSpec(object):
    ...
    swagger_types = {
        ...
        'description': 'str',
        'destination_service_accounts': 'list[V1alpha1ApplicationDestinationServiceAccount]',
    ...
    def destination_service_accounts(self):
        """Gets the destination_service_accounts of this V1alpha1AppProjectSpec.  # noqa: E501
        ...
        :return: The destination_service_accounts of this V1alpha1AppProjectSpec.  # noqa: E501
        :rtype: list[V1alpha1ApplicationDestinationServiceAccount]
        """
    ...
    def destination_service_accounts(self, destination_service_accounts):
        """Sets the destination_service_accounts of this V1alpha1AppProjectSpec.

        DestinationServiceAccounts holds information about the service accounts to be impersonated for the application sync operation for each destination.  # noqa: E501

        :param destination_service_accounts: The destination_service_accounts of this V1alpha1AppProjectSpec.  # noqa: E501
        :type: list[V1alpha1ApplicationDestinationServiceAccount]
        """
