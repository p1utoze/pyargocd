...
class V1alpha1SCMProviderGenerator(object):
    ...
    def __init__(self, aws_code_commit=None, azure_dev_ops=None, bitbucket=None, bitbucket_server=None, clone_protocol=None, filters=None, gitea=None, github=None, gitlab=None, requeue_after_seconds=None, template=None, values=None, _configuration=None):  # noqa: E501
