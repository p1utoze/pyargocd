...
```sh
pip install git+https://github.com/p1utoze/pyargocd.git
```
(you may need to run `pip` with root permission: `sudo pip install  git+https://github.com/p1utoze/pyargocd.git`)
