...
import pyargocd
from pyargocd.models.v1alpha1_sync_operation import V1alpha1SyncOperation  # noqa: E501
...
class TestV1alpha1SyncOperation(unittest.TestCase):
    ...
    def testV1alpha1SyncOperation(self):
        ...
        # model = pyargocd.models.v1alpha1_sync_operation.V1alpha1SyncOperation()  # noqa: E501
        pass
