...
import pyargocd
from pyargocd.models.v1alpha1_gnu_pg_public_key import V1alpha1GnuPGPublicKey  # noqa: E501
...
class TestV1alpha1GnuPGPublicKey(unittest.TestCase):
    ...
    def testV1alpha1GnuPGPublicKey(self):
        ...
        # model = pyargocd.models.v1alpha1_gnu_pg_public_key.V1alpha1GnuPGPublicKey()  # noqa: E501
        pass
