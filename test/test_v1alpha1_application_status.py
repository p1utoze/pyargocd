...
import pyargocd
from pyargocd.models.v1alpha1_application_status import V1alpha1ApplicationStatus  # noqa: E501
...
class TestV1alpha1ApplicationStatus(unittest.TestCase):
    ...
    def testV1alpha1ApplicationStatus(self):
        ...
        # model = pyargocd.models.v1alpha1_application_status.V1alpha1ApplicationStatus()  # noqa: E501
        pass
