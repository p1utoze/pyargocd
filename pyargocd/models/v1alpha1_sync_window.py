...
class V1alpha1SyncWindow(object):
    ...
    def __init__(self, applications=None, clusters=None, duration=None, kind=None, manual_sync=None, namespaces=None, schedule=None, time_zone=None, _configuration=None):  # noqa: E501
