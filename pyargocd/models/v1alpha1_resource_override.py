...
class V1alpha1ResourceOverride(object):
    ...
    def __init__(self, actions=None, health_lua=None, ignore_differences=None, ignore_resource_updates=None, known_type_fields=None, use_open_libs=None, _configuration=None):  # noqa: E501
