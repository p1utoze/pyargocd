...
class RepositoryParameterAnnouncement(object):
    ...
    def __init__(self, array=None, collection_type=None, item_type=None, map=None, name=None, required=None, string=None, title=None, tooltip=None, _configuration=None):  # noqa: E501
