...
class VersionVersionMessage(object):
    ...
    def __init__(self, build_date=None, compiler=None, extra_build_info=None, git_commit=None, git_tag=None, git_tree_state=None, go_version=None, helm_version=None, jsonnet_version=None, kubectl_version=None, kustomize_version=None, platform=None, version=None, _configuration=None):  # noqa: E501
