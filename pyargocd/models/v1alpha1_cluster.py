...
class V1alpha1Cluster(object):
    ...
    def __init__(self, annotations=None, cluster_resources=None, config=None, connection_state=None, info=None, labels=None, name=None, namespaces=None, project=None, refresh_requested_at=None, server=None, server_version=None, shard=None, _configuration=None):  # noqa: E501
