...
class V1alpha1ApplicationSource(object):
    ...
    def __init__(self, chart=None, directory=None, helm=None, kustomize=None, name=None, path=None, plugin=None, ref=None, repo_url=None, target_revision=None, _configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this V1alpha1ApplicationSource.  # noqa: E501

        Name is used to refer to a source and is displayed in the UI. It is used in multi-source Applications.  # noqa: E501

        :return: The name of this V1alpha1ApplicationSource.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V1alpha1ApplicationSource.

        Name is used to refer to a source and is displayed in the UI. It is used in multi-source Applications.  # noqa: E501

        :param name: The name of this V1alpha1ApplicationSource.  # noqa: E501
        :type: str
        """
