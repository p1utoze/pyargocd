...
class V1alpha1ResourceDiff(object):
    ...
    def __init__(self, diff=None, group=None, hook=None, kind=None, live_state=None, modified=None, name=None, namespace=None, normalized_live_state=None, predicted_live_state=None, resource_version=None, target_state=None, _configuration=None):  # noqa: E501
