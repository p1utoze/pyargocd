...
class ClusterServiceApi(object):
    ...
    def cluster_service_delete_with_http_info(self, id_value, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id_value' not in params or
                                                       params['id_value'] is None):  # noqa: E501
    ...
    def cluster_service_update(self, id_value, body, **kwargs):  # noqa: E501
        """Update updates a cluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_service_update(id_value, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.cluster_service_update_with_http_info(id_value, body, **kwargs)  # noqa: E501
            return data

    def cluster_service_update_with_http_info(self, id_value, body, **kwargs):  # noqa: E501
        """Update updates a cluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_service_update_with_http_info(id_value, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id_value', 'body', 'updated_fields', 'id_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
