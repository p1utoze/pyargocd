...
class ApplicationSetServiceApi(object):
    ...
    def application_set_service_create_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'upsert', 'dry_run']  # noqa: E501
    ...
    def application_set_service_generate(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ApplicationsetApplicationSetGenerateRequest body: (required)
        :return: ApplicationsetApplicationSetGenerateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def application_set_service_generate_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/applicationsets/generate', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApplicationsetApplicationSetGenerateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def application_set_service_resource_tree(self, name, **kwargs):  # noqa: E501
        """ResourceTree returns resource tree  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.application_set_service_resource_tree(name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: (required)
        :param str appset_namespace: The application set namespace. Default empty is argocd control plane namespace.
        :return: V1alpha1ApplicationSetTree
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            ...
            (data) = self.application_set_service_resource_tree_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def application_set_service_resource_tree_with_http_info(self, name, **kwargs):  # noqa: E501
        """ResourceTree returns resource tree  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.application_set_service_resource_tree_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('name' not in params or
                                                       params['name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `name` when calling `application_set_service_resource_tree`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/applicationsets/{name}/resource-tree', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1alpha1ApplicationSetTree',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
