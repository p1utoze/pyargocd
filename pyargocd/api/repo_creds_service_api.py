...
class RepoCredsServiceApi(object):
    ...
    def repo_creds_service_create_write_repository_credentials(self, body, **kwargs):  # noqa: E501
        """CreateWriteRepositoryCredentials creates a new repository credential set with write access  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_create_write_repository_credentials(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repo_creds_service_create_write_repository_credentials_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def repo_creds_service_create_write_repository_credentials_with_http_info(self, body, **kwargs):  # noqa: E501
        """CreateWriteRepositoryCredentials creates a new repository credential set with write access  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_create_write_repository_credentials_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_creds_service_create_write_repository_credentials" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `repo_creds_service_create_write_repository_credentials`")  # noqa: E501
    ...
    def repo_creds_service_delete_write_repository_credentials(self, url, **kwargs):  # noqa: E501
        """DeleteWriteRepositoryCredentials deletes a repository credential set with write access from the configuration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_delete_write_repository_credentials(url, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repo_creds_service_delete_write_repository_credentials_with_http_info(url, **kwargs)  # noqa: E501
            return data

    def repo_creds_service_delete_write_repository_credentials_with_http_info(self, url, **kwargs):  # noqa: E501
        """DeleteWriteRepositoryCredentials deletes a repository credential set with write access from the configuration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_delete_write_repository_credentials_with_http_info(url, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_creds_service_delete_write_repository_credentials" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'url' is set
        if self.api_client.client_side_validation and ('url' not in params or
                                                       params['url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `url` when calling `repo_creds_service_delete_write_repository_credentials`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/write-repocreds/{url}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_creds_service_list_write_repository_credentials(self, **kwargs):  # noqa: E501
        """ListWriteRepositoryCredentials gets a list of all configured repository credential sets that have write access  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_list_write_repository_credentials(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repo_creds_service_list_write_repository_credentials_with_http_info(**kwargs)  # noqa: E501
            return data

    def repo_creds_service_list_write_repository_credentials_with_http_info(self, **kwargs):  # noqa: E501
        """ListWriteRepositoryCredentials gets a list of all configured repository credential sets that have write access  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_list_write_repository_credentials_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_creds_service_list_write_repository_credentials" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def repo_creds_service_update_repository_credentials(self, creds_url, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str creds_url: URL is the URL to which these credentials match (required)
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repo_creds_service_update_repository_credentials_with_http_info(creds_url, body, **kwargs)  # noqa: E501
            return data

    def repo_creds_service_update_repository_credentials_with_http_info(self, creds_url, body, **kwargs):  # noqa: E501
        """UpdateRepositoryCredentials updates a repository credential set  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_update_repository_credentials_with_http_info(creds_url, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['creds_url', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('creds_url' not in params or
                                                       params['creds_url'] is None):  # noqa: E501
    ...
    def repo_creds_service_update_write_repository_credentials(self, creds_url, body, **kwargs):  # noqa: E501
        """UpdateWriteRepositoryCredentials updates a repository credential set with write access  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_update_write_repository_credentials(creds_url, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repo_creds_service_update_write_repository_credentials_with_http_info(creds_url, body, **kwargs)  # noqa: E501
            return data

    def repo_creds_service_update_write_repository_credentials_with_http_info(self, creds_url, body, **kwargs):  # noqa: E501
        """UpdateWriteRepositoryCredentials updates a repository credential set with write access  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_creds_service_update_write_repository_credentials_with_http_info(creds_url, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_creds_service_update_write_repository_credentials" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'creds_url' is set
        if self.api_client.client_side_validation and ('creds_url' not in params or
                                                       params['creds_url'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `creds_url` when calling `repo_creds_service_update_write_repository_credentials`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `repo_creds_service_update_write_repository_credentials`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/write-repocreds/{creds.url}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
