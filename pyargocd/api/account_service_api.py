...
class AccountServiceApi(object):
    ...
    def account_service_can_i_with_http_info(self, resource, action, subresource, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('subresource' not in params or
                                                       params['subresource'] is None):  # noqa: E501
    ...
    def account_service_create_token(self, name, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.account_service_create_token_with_http_info(name, body, **kwargs)  # noqa: E501
            return data

    def account_service_create_token_with_http_info(self, name, body, **kwargs):  # noqa: E501
        """CreateToken creates a token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_service_create_token_with_http_info(name, body, async_req=True)
        >>> result = thread.get()
